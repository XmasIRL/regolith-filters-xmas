...
const packsPath  = ROOT_DIR +settings?.packs_path ?? 'packs/data/exaroton_deploy/packs';
const worldsPath = ROOT_DIR +settings?.filesPath  ?? 'packs/data/exaroton_deploy/worlds';
